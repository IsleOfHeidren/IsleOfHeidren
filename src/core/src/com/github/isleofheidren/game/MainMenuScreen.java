...
//        stage.addActor(buttonPanel);
        ...
        //TODO remove dis
        CombatController controller = new CombatController(null, console);
        CombatEvent ce = new CombatEvent();
        ce.setMonsters(new String[] {"hydra"});

        controller.StartCombat(ce, players.toArray(new PlayerCharacter[0]));

        PlayerCharacter currentPlayer = controller.getCurrentPlayer();
        controller.doNextTurn(currentPlayer.getAllActionsForPlayer().get(0));
    }
